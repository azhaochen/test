...
class Mycurl
{
	...
	public function setHeader($headerArr)
	{
		...
		//$headerArr=array('Content-type: text/html', 'Expect:')
		//注意：setting CURLOPT_HTTPHEADER more than once will clear out any headers you've set previously with CURLOPT_HTTPHEADER.
